package com.aigo.leaderboard.config;
...
public class CacheConfig {
    ...
    //    required so cache HITS deserialize back into the original type
    //    (e.g. LeaderboardEntry, or List<Map<String,Object>>) instead of a
    //    raw LinkedHashMap/ArrayList.
    @Bean
